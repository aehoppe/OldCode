...
/**
 * This class tests the functionality of the ArrayUnboundedQueue class
...
public class ArrayUnboundedQueueTest {
    ...
    //fields
    /**
     * A ArrayUnboundedQueue with 2 elements
     */
    ArrayUnboundedQueue a;
    
    /**
     * A ArrayUnboundedQueue with 4 elements
     */
    ArrayUnboundedQueue b; 
    
    /**
     * An empty ArrayUnboundedQueue with 0 elements
     */
    ArrayUnboundedQueue e;
    
    /**
     * A ArrayUnboundedQueue that will be partially filled, size 3
     */
    ArrayUnboundedQueue p1;
    
    /**
     * A ArrayUnboundedQueue that will be partially filled, size 2
     */
    ArrayUnboundedQueue p2;
    
    /**
     * A ArrayUnboundedQueue that is almost empty, size 1,
     */
    ArrayUnboundedQueue ae;
    ...
    @Before
    public void setup() {
        a = new ArrayUnboundedQueue();
        b = new ArrayUnboundedQueue();
        e = new ArrayUnboundedQueue();
        p1 = new ArrayUnboundedQueue();
        p2 = new ArrayUnboundedQueue();
        ae = new ArrayUnboundedQueue();
