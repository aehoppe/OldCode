...
/**
 * Class OceanPanel displays a grid of SeaCreature objects
 * 
...
public class OceanPanel extends JPanel {
    ...
    public OceanPanel(OceanModel model) {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setFont(myFont);
        Iterator<SeaCreature> i = myModel.iterator();
        while (i.hasNext()) {
            SeaCreature next = i.next();
